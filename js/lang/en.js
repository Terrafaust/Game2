// js/lang/en.js (v4.3 - Added Resource Keys)
// English language pack with all required keys for the refactored UI.

export default {
    // MODIFICATION: Added resource names
    "resources.studyPoints.name": "Study Points",
    "resources.knowledge.name": "Knowledge",
    "resources.images.name": "Images",
    "resources.studySkillPoints.name": "Study Skill Points",
    "resources.prestigeSkillPoints.name": "Prestige Skill Points",
    "resources.prestigePoints.name": "Prestige Points",
    ...
    "core_gameplay.ui.tab_label": "Study Area",
