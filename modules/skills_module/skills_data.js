// modules/skills_module/skills_data.js (v5.0 - Skill Effect Overhaul)

/**
 * @file skills_data.js
 * @description Static data definitions for the Skills module.
 * v5.0: Complete overhaul of numerous skill effects and descriptions based on user feedback.
...
export const staticModuleData = {
    ...
    skills: {
        ...
        // --- MODIFICATION: Tier 4 skill effects updated ---
        ...
        // --- MODIFICATION: Tier 5 skill effect updated ---
        ...
        ProfessorSupervision: { id: 'professorSupervision', tier: 5, name : "Professor Supervision", description : "Professor initial cost is 5% cheaper.", maxLevel: 4, costPerLevel: createSkillLevelCosts(5, 4), effects: { type : "COST_REDUCTION_MULTIPLIER", targetSystem: "studies_producers", targetId: "professor", valuePerLevel: "0.05" }, unlockCondition: { type : "skillLevel", skillId: "lowerTierBoost", level: 1 } },
        overallCostReduction: { id: 'overallCostReduction', tier: 5, name: "Economic Efficiency", description: "Reduces cost of ALL Study producers by 2% per level.", maxLevel: 3, costPerLevel: createSkillLevelCosts(5, 3), effect: { type: "COST_REDUCTION_MULTIPLIER", targetSystem: "studies_producers", targetId: "ALL", valuePerLevel: "0.02" }, unlockCondition: { type: "skillLevel", skillId: "professorSupervision", level: 1 } },
        // --- MODIFICATION: Tier 6 skill effects updated ---
        synergisticStudies: { id: 'synergisticStudies', tier: 6, name: "Synergistic Studies", description: "All Study producers (Student to University) gain +50% production per level. Professor output +25% per level.", maxLevel: 2, costPerLevel: createSkillLevelCosts(6, 2), effects: [ { type: "MULTIPLIER", targetSystem: "studies_producers", targetId: "student", valuePerLevel: "0.50", aggregation: "ADDITIVE_TO_BASE_FOR_MULTIPLIER" }, { type: "MULTIPLIER", targetSystem: "studies_producers", targetId: "classroom", valuePerLevel: "0.50", aggregation: "ADDITIVE_TO_BASE_FOR_MULTIPLIER" }, { type: "MULTIPLIER", targetSystem: "studies_producers", targetId: "kindergarten", valuePerLevel: "0.50", aggregation: "ADDITIVE_TO_BASE_FOR_MULTIPLIER" }, { type: "MULTIPLIER", targetSystem: "studies_producers", targetId: "elementarySchool", valuePerLevel: "0.50", aggregation: "ADDITIVE_TO_BASE_FOR_MULTIPLIER" }, { type: "MULTIPLIER", targetSystem: "studies_producers", targetId: "middleSchool", valuePerLevel: "0.50", aggregation: "ADDITIVE_TO_BASE_FOR_MULTIPLIER" }, { type: "MULTIPLIER", targetSystem: "studies_producers", targetId: "highSchool", valuePerLevel: "0.50", aggregation: "ADDITIVE_TO_BASE_FOR_MULTIPLIER" }, { type: "MULTIPLIER", targetSystem: "studies_producers", targetId: "university", valuePerLevel: "0.50", aggregation: "ADDITIVE_TO_BASE_FOR_MULTIPLIER" }, { type: "MULTIPLIER", targetSystem: "studies_producers_knowledge", targetId: "professor", valuePerLevel: "0.25", aggregation: "ADDITIVE_TO_BASE_FOR_MULTIPLIER" } ], unlockCondition: { type: "allSkillsInTierLevel", tier: 5, level: 1 } },
    ...
    prestigeSkills: {
        ...
        // --- MODIFICATION: Tier 2 Prestige skill effects updated ---
        startingAdvantage: { id: 'startingAdvantage', tier: 2, name: "Starting Advantage", description: "Start each prestige with 10 free Students and 5 free Classrooms per level.", maxLevel: 5, costPerLevel: createPrestigeSkillLevelCosts(2, 5), effect: { type: "MANUAL", description: "Grants free producers on prestige." } },
        acceleratedLearning: { id: 'acceleratedLearning', tier: 2, name: "Accelerated Learning", description: "All Study Producers cost 5% less per level.", maxLevel: 10, costPerLevel: createPrestigeSkillLevelCosts(2, 10), effect: { type: "COST_REDUCTION_MULTIPLIER", targetSystem: "studies_producers", targetId: "ALL", valuePerLevel: "0.05" } },
        licensedEfficiency: { id: 'licensedEfficiency', tier: 3, name: "Licensed Efficiency", description: "License prestige producers are 50% more effective per level.", maxLevel: 5, costPerLevel: createPrestigeSkillLevelCosts(3, 5), effect: { type: "MULTIPLIER", targetSystem: "prestige_producers", targetId: "license", valuePerLevel: "0.50", aggregation: "ADDITIVE_TO_BASE_FOR_MULTIPLIER" } },
        mastersProgram: { id: 'mastersProgram', tier: 3, name: "Master's Program", description: "Master's Degree I & II prestige producers are 50% more effective per level.", maxLevel: 5, costPerLevel: createPrestigeSkillLevelCosts(3, 5), effects: [{ type: "MULTIPLIER", targetSystem: "prestige_producers", targetId: "master1", valuePerLevel: "0.50", aggregation: "ADDITIVE_TO_BASE_FOR_MULTIPLIER" }, { type: "MULTIPLIER", targetSystem: "prestige_producers", targetId: "master2", valuePerLevel: "0.50", aggregation: "ADDITIVE_TO_BASE_FOR_MULTIPLIER" }] },
        scholarlySynergy: { id: 'scholarlySynergy', tier: 4, name: "Scholarly Synergy", description: "PhD and Post-Doctorate prestige producers are 25% more effective per level.", maxLevel: 5, costPerLevel: createPrestigeSkillLevelCosts(4, 5), effects: [ { type: "MULTIPLIER", targetSystem: "prestige_producers", targetId: "phd", valuePerLevel: "0.25", aggregation: "ADDITIVE_TO_BASE_FOR_MULTIPLIER" }, { type: "MULTIPLIER", targetSystem: "prestige_producers", targetId: "postDoc", valuePerLevel: "0.25", aggregation: "ADDITIVE_TO_BASE_FOR_MULTIPLIER" } ] },
        permanentKnowledge: { id: 'permanentKnowledge', tier: 4, name: "Permanent Knowledge", description: "Start each prestige with 1% of your previous prestige's Knowledge per level.", maxLevel: 10, costPerLevel: createPrestigeSkillLevelCosts(4, 10), effect: { type: "MANUAL", description: "Retain a percentage of Knowledge on prestige." } },
        // --- MODIFICATION: Tier 5-8 Prestige skill effects updated ---
        prestigePower: { id: 'prestigePower', tier: 5, name: "Prestige Power", description: "The Prestige Bonus multiplier is boosted by a further 10% per level.", maxLevel: 5, costPerLevel: createPrestigeSkillLevelCosts(5, 5), effect: { type: "MULTIPLIER", targetSystem: "prestige_mechanics", targetId: "prestigeBonus", valuePerLevel: "0.10", aggregation: "ADDITIVE_TO_BASE_FOR_MULTIPLIER" } },
        prestigeEconomics: { id: 'prestigeEconomics', tier: 5, name: "Prestige Economics", description: "All Prestige Producers cost 5% less per level.", maxLevel: 10, costPerLevel: createPrestigeSkillLevelCosts(5, 10), effect: { type: "COST_REDUCTION_MULTIPLIER", targetSystem: "prestige_producers", targetId: "ALL", valuePerLevel: "0.05" } },
        synergisticPrestige: { id: 'synergisticPrestige', tier: 6, name: "Synergistic Prestige", description: "Total Study Skill Points spent during this run increase Prestige Point gain by 1% per point.", maxLevel: 1, costPerLevel: createPrestigeSkillLevelCosts(6, 1), effect: { type: "SSP_BASED_PP_MULTIPLIER" } },
        retainedSkills: { id: 'retainedSkills', tier: 6, name: "Retained Skills", description: "Keep 5% of your Study Skill Points on prestige per level.", maxLevel: 10, costPerLevel: createPrestigeSkillLevelCosts(6, 10), effect: { type: "MANUAL" } },
        ppOverdrive: { id: 'ppOverdrive', tier: 7, name: "PP Overdrive", description: "The magnitude of your total Prestige Points earned boosts ALL production. (+10% per magnitude)", maxLevel: 1, costPerLevel: createPrestigeSkillLevelCosts(7, 1), effect: { type: "TOTAL_PP_BASED_GLOBAL_MULTIPLIER", valuePerMagnitude: "0.1" } },
        echoesOfPower: { id: 'echoesOfPower', tier: 7, name: "Echoes of Power", description: "Boosts the production of ALL Prestige producers by 5% per level.", maxLevel: 20, costPerLevel: createPrestigeSkillLevelCosts(7, 20), effect: { type: "MULTIPLIER", targetSystem: "prestige_producers", targetId: 'ALL', valuePerLevel: "0.05", aggregation: "ADDITIVE_TO_BASE_FOR_MULTIPLIER" } },
        singularity: { id: 'singularity', tier: 8, name: "Singularity", description: "All multipliers from regular skills are squared.", maxLevel: 1, costPerLevel: createPrestigeSkillLevelCosts(8, 1), effect: { type: "SQUARE_STUDY_SKILL_MULTIPLIERS" } },
        transcendence: { id: 'transcendence', tier: 8, name: "Transcendence", description: "Unlocks a new, secret game mechanic after the next prestige.", maxLevel: 1, costPerLevel: createPrestigeSkillLevelCosts(8, 1), effect: { type: "UNLOCK_SECRET_MECHANIC" } },
    },
