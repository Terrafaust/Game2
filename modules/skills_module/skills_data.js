...
// --- Cost structure for regular skills ---
...
// --- Cost structure for prestige skills ---
const prestigeSkillCostsPerLevelByTier = {
    1: "1",      // Tier 1: 1 AP per level
    2: "2",     // Tier 2: 2 AP per level
    3: "3",    // Tier 3: 3 AP per level
    4: "5",    // Tier 4: 5 AP per level
    5: "10",   // Tier 5: 10 AP per level
    6: "25",  // Tier 6: 25 AP per level
    7: "100",  // Tier 7: 100 AP per level
    8: "10000"  // Tier 8: 10,000 AP per level
};
...
export const staticModuleData = {
    ...
    skills: {
        ...
        // --- Tier 6: Advanced Synergies (2 Skills) ---
        ...
        // --- Tier 7: Peak Efficiency (2 Skills) ---
        ...
        // --- Tier 8: Ultimate Knowledge (2 Skills) ---
    ...
    prestigeSkills: {
        ...
        transcendence: { id: 'transcendence', tier: 8, name: "Transcendence", description: "Unlocks a new, secret game mechanic after the next prestige.", maxLevel: 1, costPerLevel: createPrestigeSkillLevelCosts(8, 1), effect: { type: "UNLOCK_SECRET_MECHANIC" }, unlockCondition: { type: "prestigeSkillLevel", skillId: "singularity", level: 1 } },
    },
